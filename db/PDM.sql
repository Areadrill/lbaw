...
CREATE TABLE Project(
	...
	creator INT REFERENCES Users(userID) NOT NULL ON DELETE CASCADE,
	creationDate TIMESTAMP NOT NULL
);
DROP TABLE IF EXISTS Roles CASCADE;
CREATE TABLE Roles(
	userID INT REFERENCES Users(userID) NOT NULL ON DELETE CASCADE,
	projectID INT REFERENCES Project(projectID) NOT NULL ON DELETE CASCADE,
...
CREATE TABLE TaskToLabel(
	taskID INT REFERENCES Task(taskID) NOT NULL ON DELETE CASCADE,
	taskLID INT REFERENCES TaskLabel(taskLID) NOT NULL ON DELETE CASCADE,
...
CREATE TABLE Comment(
	...
	threadID INT REFERENCES Thread(threadID) NOT NULL ON DELETE CASCADE,
	commentor INT REFERENCES Users(userID) NOT NULL,
	creationInfo TIMESTAMP NOT NULL,
	text VARCHAR(512) NOT NULL
);

...
if (!isset($_SESSION['userid'])){
	error_log('User was not logged in on actions/projects/add_task_tasklist.php');
	exit;
}

if(checkPrivilege($_SESSION['userid'], $_POST['projectID']) != "COORD"){
	$_SESSION['error_messages'][] = "You don't have provevileges to adda task to a tasklist";
	$_SESSION['form_values'] = $_POST;
	header('Location: ' . $_SERVER['HTTP_REFERER']);
}
